...
Public Class vp1
    ...
    Private Sub vp1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        MenuStrip1.Visible = False
        TextBox1.ReadOnly = True
        LinkLabel8.Visible = False
        TextBox2.ReadOnly = True
