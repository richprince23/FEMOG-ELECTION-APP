...
Public Class Form8
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            Else
                ...
                cmd.Connection = con
                cmd.CommandText = "INSERT INTO login" & "(usrn,pswd)" & "VALUES(@usrn,@pswd)"
                cmd.Parameters.AddWithValue("@usrn", TextBox1.Text)
    ...
    Private Sub Form8_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            'TODO: This line of code loads data into the 'RegDataSet1.login' table. You can move, or remove it, as needed.
            Me.LoginTableAdapter.Fill(Me.RegDataSet1.login)
