...
Public Class GNDP2
    ...
    Private p1 As String = Application.StartupPath & "\pm1.jpg"
    Private p2 As String = Application.StartupPath & "\pm2.jpg"
    Private p3 As String = Application.StartupPath & "\pm3.jpg"
    Private p4 As String = Application.StartupPath & "\pm4.jpg"
    Private p5 As String = Application.StartupPath & "\pm5.jpg"
    Private p6 As String = Application.StartupPath & "\pm6.jpg"

    Private Sub GNDP2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        a1 = a1 + 1
        VCGNDP2.TextBox1.Text = a1
        Me.Hide()
        Beep()
        Dim sapi
        sapi = CreateObject("sapi.spvoice")
        sapi.speak("Thank You for voting, you can now leave the panel ")
        'diable buttons
        disablebtns()
        ve.Show()
    End Sub
